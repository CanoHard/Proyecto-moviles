...
class VideoTracker(object):
    def __init__(self, args):
        ...
        self.person_detection = rospy.Publisher("/person_tracking/person_detections", Int32, queue_size=1)
    ...
    def ros_deepsort_callback(self, ros_data):
        ...
        num_personas = bbox_xywh.shape[0]
        ...
        self.person_detection.publish(Int32(num_personas)) # Publica el topic con el numero de personas en el frame
