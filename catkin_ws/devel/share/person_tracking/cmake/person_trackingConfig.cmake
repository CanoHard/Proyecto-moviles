...
if(NOT "/home/pablocano/Proyecto-moviles/catkin_ws/devel/include " STREQUAL " ")
  set(person_tracking_INCLUDE_DIRS "")
  set(_include_dirs "/home/pablocano/Proyecto-moviles/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'person_tracking' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pablocano/Proyecto-moviles/catkin_ws/src/person_tracking_ros/${idir}'.  ${_report}")
    endif()
