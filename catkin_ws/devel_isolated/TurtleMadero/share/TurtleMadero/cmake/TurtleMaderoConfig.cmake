...
if(TurtleMadero_CONFIG_INCLUDED)
  return()
endif()
set(TurtleMadero_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(TurtleMadero_SOURCE_PREFIX /home/pablocano/Proyecto-moviles/catkin_ws/src/TurtleMadero)
  set(TurtleMadero_DEVEL_PREFIX /home/pablocano/Proyecto-moviles/catkin_ws/devel_isolated/TurtleMadero)
  set(TurtleMadero_INSTALL_PREFIX "")
  set(TurtleMadero_PREFIX ${TurtleMadero_DEVEL_PREFIX})
else()
  set(TurtleMadero_SOURCE_PREFIX "")
  set(TurtleMadero_DEVEL_PREFIX "")
  set(TurtleMadero_INSTALL_PREFIX /home/pablocano/Proyecto-moviles/catkin_ws/install_isolated)
  set(TurtleMadero_PREFIX ${TurtleMadero_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'TurtleMadero' is deprecated")
...
set(TurtleMadero_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(TurtleMadero_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${TurtleMadero_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'TurtleMadero' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'TurtleMadero' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pablocano/Proyecto-moviles/catkin_ws/src/TurtleMadero/${idir}'.  ${_report}")
    endif()
    _list_append_unique(TurtleMadero_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND TurtleMadero_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND TurtleMadero_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT TurtleMadero_NUM_DUMMY_TARGETS)
      set(TurtleMadero_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::TurtleMadero::wrapped-linker-option${TurtleMadero_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR TurtleMadero_NUM_DUMMY_TARGETS "${TurtleMadero_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::TurtleMadero::wrapped-linker-option${TurtleMadero_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND TurtleMadero_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(TurtleMadero_LIBRARY_DIRS ${lib_path})
      list(APPEND TurtleMadero_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'TurtleMadero'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND TurtleMadero_LIBRARIES ${lib})
    endif()
  endif()
...
set(TurtleMadero_EXPORTED_TARGETS "TurtleMadero_generate_messages_cpp;TurtleMadero_generate_messages_eus;TurtleMadero_generate_messages_lisp;TurtleMadero_generate_messages_nodejs;TurtleMadero_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${TurtleMadero_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "actionlib;move_base_msgs;rospy;std_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 TurtleMadero_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${TurtleMadero_dep}_FOUND)
      find_package(${TurtleMadero_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${TurtleMadero_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(TurtleMadero_INCLUDE_DIRS ${${TurtleMadero_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(TurtleMadero_LIBRARIES ${TurtleMadero_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${TurtleMadero_dep}_LIBRARIES})
  _list_append_deduplicate(TurtleMadero_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(TurtleMadero_LIBRARIES ${TurtleMadero_LIBRARIES})

  _list_append_unique(TurtleMadero_LIBRARY_DIRS ${${TurtleMadero_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(TurtleMadero_EXPORTED_TARGETS ${${TurtleMadero_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "TurtleMadero-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${TurtleMadero_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
